...
class EncryptionService {
    ...
    func decrypt(encryptedData: Data, withPassword password: String) throws -> Data {
        ...
        // We extract the IV but it's actually included in the sealedBoxData for AES.GCM.SealedBox
        // so we don't need to use it separately
        _ = encryptedData.subdata(in: saltLength..<(saltLength + ivLength))
