...
struct StocklyApp: App {
    ...
    var body: some Scene {
        ...
        .modelContainer(for: [Item.self, User.self, Category.self, CustomField.self, Client.self, Supplier.self, Invoice.self, InvoiceItem.self, CustomInvoiceField.self, Estimate.self, EstimateItem.self, CustomEstimateField.self])
    }
}
